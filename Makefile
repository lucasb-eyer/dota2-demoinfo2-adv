...
# -DOUTPUT_AUTODEMSON_USER -DOUTPUT_AUTODEMSON_NET
# -DOUTPUT_ORIGINAL
# -DOUTPUT_GameEvent -DOUTPUT_ChatEvent
# -DOUTPUT_AUTODEMSON_NET -DOUTPUT_ORIGINAL -DOUTPUT_AUTODEMSON_USER -DOUTPUT_RAWDATA_IN_DEMSON
CXX_FLAGS=-I/usr/include -L/usr/lib -DOUTPUT_GameEvent -DOUTPUT_ChatEvent -DOUTPUT_UnitEvent
